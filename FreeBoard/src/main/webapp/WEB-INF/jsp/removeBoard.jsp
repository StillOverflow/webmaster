...
<table class="table">
	...
	<tr>
		<th>제목</th><td colspan="3"><input type="text" class="form-control" name="title" value="<%=bvo.getTitle()%>" readonly></td>
	</tr>
	<tr>
		<th>내용</th><td colspan="3"><textarea rows="8" cols="30" name="content" class="form-control" readonly><%=bvo.getContent() %></textarea></td>
	</tr>
	<tr>
		<th>작성자</th><td colspan="3"><%=bvo.getWriter()%></td>
	</tr>
	<tr>
		<th>작성일시</th><td colspan="3"><%=writeDate%></td>
	</tr>
	<tr>
